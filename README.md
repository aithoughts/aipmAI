...
[主页](https://www.theforage.cn/) | [aipmAI - crewAI 中文解决方案](https://aipmai.theforage.cn/) | [与文档聊天](https://chatg.pt/DWjSBZn) | [示例](https://github.com/aithoughts/aipmAI-examples) | [Discord](https://discord.com/invite/X4JWnZnxPb)
...
# 您可以选择通过 Ollama 使用本地模型。有关更多信息，请参阅 https://aipmai.theforage.cn/how-to/LLM-Connections/。
...
# 模型，如 OpenAI、Mistral、Antrophic 或其他（https://aipmai.theforage.cn/how-to/LLM-Connections/）
#
# import os
...
除了顺序流程之外，您还可以使用分层流程，该流程会自动为定义的团队分配一名经理，以通过委派和验证结果来正确协调任务的计划和执行。[在此处了解更多关于流程的信息](https://aipmai.theforage.cn/core-concepts/Processes/)。
...
- **与开源模型配合使用**: 使用 Open AI 或开源模型运行您的团队，请参阅 [将 crewAI 连接到 LLM](https://aipmai.theforage.cn/how-to/LLM-Connections/) 页面，了解有关配置您的代理与模型（甚至是本地运行的模型）连接的详细信息！
...
- [在执行过程中获得人工输入](https://aipmai.theforage.cn/how-to/Human-Input-on-Execution)
...
有关配置代理与模型连接的详细信息，请参阅 [将 crewAI 连接到 LLM](https://aipmai.theforage.cn/how-to/LLM-Connections/) 页面。
